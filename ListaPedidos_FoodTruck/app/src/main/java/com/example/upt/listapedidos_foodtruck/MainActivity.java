...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Intent.ACTION_SEND.equals(action) && type != null) //verifica si es diferente de nulo y a accion enviada
        {
            if("text/plain".equals(type)) //VERIFICA SI ES UN TEXT PLANO
            {
